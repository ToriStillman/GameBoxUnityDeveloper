...
public class Subtitle : MonoBehaviour
{
    ...
    private void TextLevel1()
    {
        ...
        dialogueStart[1] = "Но все изменилось, когда Белые Ходаки напали на мой родной город.";
        dialogueStart[2] = "Все жители спрятались в ледяных сугробах, а я... я не буду прятаться.";
        dialogueStart[3] = "Есть легенда, что Санта сможет уничтожить Ходаков, а значит, мне нужно найти его.";
